                            ...
                            <div className="option-content">
                                {
                                    Brands.map((brand1, index) => {
                                        return <NavLink key={index} to={"/products/" + brand1}><button className={(getBrand != null && getBrand.toLowerCase() === brand1.toLowerCase()) ? "button-search-active" : (brandX === brand1 ? "button-search-active" : "")} onClick={() => { dispatch(pick(brand1)), dispatch(brand(brand1)) }}>{brand1}</button></NavLink>
                                    })
                                }
                            </div>
                        </Col>
